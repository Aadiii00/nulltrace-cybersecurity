...
from sentinel_service import router as sentinel_service_router
...
app.include_router(sentinel_service_router)
print("[Nulltrace] OK Network scanner, Subdomain discovery, SOC Workbench, AI Malware Analysis, and Sentinel Agent routers loaded.")
